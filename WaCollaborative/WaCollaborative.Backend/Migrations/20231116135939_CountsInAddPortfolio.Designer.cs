...
namespace WaCollaborative.Backend.Migrations
{
    ...
    [Migration("20231116135939_CountsInAddPortfolio")]
    partial class CountsInAddPortfolio
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WaCollaborative.Shared.Entities.PortfolioCustomerProduct", b =>
                {
                    ...
                    b.Property<int?>("PortfolioCustomerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WaCollaborative.Shared.Entities.PortfolioCustomerProduct", b =>
                {
                    b.HasOne("WaCollaborative.Shared.Entities.PortfolioCustomer", "PortfolioCustomer")
                        .WithMany("PortfolioCustomerProducts")
                        .HasForeignKey("PortfolioCustomerId");

                    b.HasOne("WaCollaborative.Shared.Entities.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId");

                    b.Navigation("PortfolioCustomer");
            ...
            modelBuilder.Entity("WaCollaborative.Shared.Entities.PortfolioCustomer", b =>
                {
                    b.Navigation("PortfolioCustomerProducts");
                });

...
namespace WaCollaborative.Backend.Migrations
{
    ...
    [Migration("20231123201130_AddCollaborativeDemandUsers")]
    partial class AddCollaborativeDemandUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WaCollaborative.Shared.Entities.CollaborationCalendar", b =>
                {
                    ...
                    b.Property<int?>("CollaborationCycleId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CollaborationCycleId");
            ...
            modelBuilder.Entity("WaCollaborative.Shared.Entities.CollaborationCycle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WaCollaborative.Shared.Entities.CollaborativeDemandDemo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WaCollaborative.Shared.Entities.CollaborationCalendar", b =>
                {
                    b.HasOne("WaCollaborative.Shared.Entities.CollaborationCycle", "CollaborationCycle")
                        .WithMany("CollaborationCalendars")
                        .HasForeignKey("CollaborationCycleId");

                    b.HasOne("WaCollaborative.Shared.Entities.InternalRole", "InternalRole")
                        .WithMany("CollaborationCalendars")
                        .HasForeignKey("InternalRoleId");

                    b.Navigation("CollaborationCycle");

...
namespace WaCollaborative.UnitTest.Controllers
{
    ...
    public class CustomersControllerTests
    {
        ...
        private readonly Mock<IGenericUnitOfWork<Customer>> _unitOfWorkMock;
        ...
        public CustomersControllerTests()
        {
            _options = new DbContextOptionsBuilder<DataContext>()
             ...
             .Options;
            _unitOfWorkMock = new Mock<IGenericUnitOfWork<Customer>>();
        }
        ...
        public async Task GetAsyncWithId_ReturnsOkResult()
        {
            ...
            /// Act
            var result = await controller.GetAsync(id) as OkObjectResult;
            Customer resultCustomer = (Customer)result!.Value!;

            /// Assert
            Assert.IsNotNull(result);
            Assert.AreEqual(200, result.StatusCode);
            Assert.AreEqual(resultCustomer.Name, "Test");
